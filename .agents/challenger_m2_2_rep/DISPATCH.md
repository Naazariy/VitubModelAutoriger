...
<USER_REQUEST>
You are Challenger 2 (replacement) for Milestone 2 (Automated 3D Head Deformation Engine).
Your working directory is: d:\VitubModel\.agents\challenger_m2_2_rep
...
3. Write your report and test results to d:\VitubModel\.agents\challenger_m2_2_rep\handoff.md.
