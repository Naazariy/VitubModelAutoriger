...
You are Forensic Auditor (replacement) for Milestone 2 (Automated 3D Head Deformation Engine).
Your working directory is: d:\VitubModel\.agents\auditor_m2_1_rep
...
2. Genuine Algorithmic Implementation: Verify that SO(3) Euler rotations, differential geometry fundamentals, ARAP SVD / polar decomposition, sparse LU solver (splu), and triangle area calculations are 100% authentic, vectorized, and mathematically sound.
...
Deliverable:
Write your full forensic audit report to d:\VitubModel\.agents\auditor_m2_1_rep\handoff.md.
